...
function getInquiryMessage(productType, selection) {
    ...
    if (template) {
        ...
        return template
            ...
            .replace('{country}', selection.country)
...
I am interested in purchasing ${productName} from ${selection.country} (${selection.manufacturer}).
...
function updateSelectedOrigins() {
    Object.keys(selectedProducts).forEach(productType => {
        ...
        // Update the product name in the selection
