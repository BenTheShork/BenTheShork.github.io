...
function updateCurrentLanguageDisplay() {
    ...
    if (flagElement && codeElement && config) {
...
// Close other dropdowns (products origins, etc.)
function closeOtherDropdowns() {
    // Close products dropdowns if they exist
    if (typeof closeDropdown === 'function') {
        document.querySelectorAll('.origins-dropdown.active').forEach(d => {
            const productType = d.id.replace('origins-', '');
